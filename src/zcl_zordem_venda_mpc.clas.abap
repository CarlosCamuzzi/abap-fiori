class ZCL_ZORDEM_VENDA_MPC definition
  public
...
public section.
  ...
  types:
    begin of TS_ZFI_ATUALIZA_STATUS_01,
        ID_ORDEMID type I,
        ID_STATUS type C length 1,
    end of TS_ZFI_ATUALIZA_STATUS_01 .
  types:
  begin of TS_CABECALHO,
     ORDEMID type I,
  ...
  types:
TT_CABECALHO type standard table of TS_CABECALHO .
  types:
  begin of TS_ITEM,
     ORDEMID type I,
     ITEMID type I,
...
TT_MENSAGEM type standard table of TS_MENSAGEM .
  ...
  constants GC_CABECALHO type /IWBEP/IF_MGW_MED_ODATA_TYPES=>TY_E_MED_ENTITY_NAME value 'Cabecalho' ##NO_TEXT.
...
private section.
  ...
  constants GC_INCL_NAME type STRING value 'ZCL_ZORDEM_VENDA_MPC==========CP' ##NO_TEXT.

  methods DEFINE_COMPLEXTYPES
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_CABECALHO
    raising
      /IWBEP/CX_MGW_MED_EXCEPTION .
  methods DEFINE_ITEM
    raising
...
CLASS ZCL_ZORDEM_VENDA_MPC IMPLEMENTATION.
...
model->set_schema_namespace( 'ZORDEM_VENDA_SRV' ).
...
***********************************************************************************************************************************
 ...
 lo_association = model->create_association(
                            ...
                            iv_left_type        = 'Cabecalho' "#EC NOTEXT
...
lo_assoc_set = model->create_association_set( iv_association_set_name  = 'CabItemSet'                         "#EC NOTEXT
                                              iv_left_entity_set_name  = 'CabecalhoSet'              "#EC NOTEXT
...
* Navigation Properties for entity - Cabecalho
lo_entity_type = model->get_entity_type( iv_entity_name = 'Cabecalho' ). "#EC NOTEXT
...
lo_entity_type = model->create_entity_type( iv_entity_type_name = 'Cabecalho' iv_def_entity_set = abap_false ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZORDEM_VENDA_MPC=>TS_CABECALHO' ). "#EC NOTEXT


***********************************************************************************************************************************
*   ENTITY SETS
***********************************************************************************************************************************
lo_entity_set = lo_entity_type->create_entity_set( 'CabecalhoSet' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZORDEM_VENDA_MPC=>TS_ITEM' ). "#EC NOTEXT
...
lo_entity_type->bind_structure( iv_structure_name  = 'ZCL_ZORDEM_VENDA_MPC=>TS_MENSAGEM' ). "#EC NOTEXT
...
*&---------------------------------------------------------------------*
  ...
  CONSTANTS: lc_gen_date_time TYPE timestamp VALUE '20250205201536'.                  "#EC NOTEXT
...
ls_text_element-parent_artifact_name   = 'Cabecalho'.                            "#EC NOTEXT
...
***********************************************************************************************************************************
*   ACTION - ZFI_ATUALIZA_STATUS_01
***********************************************************************************************************************************

lo_action = model->create_action( 'ZFI_ATUALIZA_STATUS_01' ).  "#EC NOTEXT
...
lo_action->bind_input_structure( iv_structure_name  = 'ZCL_ZORDEM_VENDA_MPC=>TS_ZFI_ATUALIZA_STATUS_01' ). "#EC NOTEXT
  endmethod.
...
lo_property->set_nullable( abap_false ).
lo_property->set_filterable( abap_false ).
lo_complex_type->bind_structure( iv_structure_name = 'ZCL_ZORDEM_VENDA_MPC=>MENSAGEM2' ). "#EC NOTEXT
  endmethod.
ENDCLASS.
